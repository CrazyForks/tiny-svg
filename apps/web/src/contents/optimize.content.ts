...
const optimizeContent = {
  ...
  content: {
    ...
    preview: {
      noSvg: t({
        en: "No SVG to preview",
        zh: "无可预览的 SVG",
        ko: "미리 볼 SVG가 없습니다",
        de: "Kein SVG zur Vorschau",
        fr: "Aucun SVG à prévisualiser",
      }),
      rotate: t({
        en: "Rotate 90°",
        zh: "旋转 90°",
      ...
      showOutline: t({
        en: "Show viewBox outline",
        zh: "显示 viewBox 轮廓",
        ko: "viewBox 윤곽 표시",
        de: "ViewBox-Umriss anzeigen",
        fr: "Afficher le contour de viewBox",
      }),
      hideOutline: t({
        en: "Hide viewBox outline",
        zh: "隐藏 viewBox 轮廓",
        ko: "viewBox 윤곽 숨기기",
        de: "ViewBox-Umriss ausblenden",
        fr: "Masquer le contour de viewBox",
      }),
      zoomIn: t({
        en: "Zoom in (hold for continuous zoom)",
        zh: "放大（按住连续缩放）",
        ko: "확대 (누르고 있으면 연속 확대)",
        de: "Vergrößern (halten für kontinuierliches Zoomen)",
        fr: "Zoomer (maintenir pour un zoom continu)",
      }),
      zoomOut: t({
        en: "Zoom out (hold for continuous zoom)",
        zh: "缩小（按住连续缩放）",
        ko: "축소 (누르고 있으면 연속 축소)",
        de: "Verkleinern (halten für kontinuierliches Zoomen)",
        fr: "Dézoomer (maintenir pour un zoom continu)",
      }),
      resetZoom: t({
        en: "Reset zoom",
        zh: "重置缩放",
      ...
      showOutlineShort: t({
        ...
        ko: "윤곽 표시",
        de: "Umriss anzeigen",
        fr: "Afficher le contour",
      }),
      hideOutlineShort: t({
        en: "Hide Outline",
        zh: "隐藏轮廓",
        ko: "윤곽 숨기기",
        de: "Umriss ausblenden",
        fr: "Masquer le contour",
      }),
      canvasAriaLabel: t({
        en: "SVG preview canvas - use mouse wheel to zoom, click and drag to pan",
        zh: "SVG 预览画布 - 使用鼠标滚轮缩放，点击并拖动平移",
        ko: "SVG 미리보기 캔버스 - 마우스 휠로 확대/축소, 클릭 및 드래그로 이동",
        de: "SVG-Vorschau-Leinwand - Mausrad zum Zoomen, Klicken und Ziehen zum Verschieben",
        fr: "Canevas d'aperçu SVG - utilisez la molette pour zoomer, cliquez et faites glisser pour déplacer",
      }),
    },
  },
